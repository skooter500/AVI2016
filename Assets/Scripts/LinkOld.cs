...
namespace Topology {
	...
	public class LinkOld: MonoBehaviour {
		...
		void Start () {
			...
			center = GameObject.Find ("GameController");
...
//				Vector3 m = Vector3.MoveTowards(transform.position, center.transform.position, 1);

				lineRenderer.SetPosition(0, source.transform.position);
				lineRenderer.SetPosition(1, target.transform.position);
//				lineRenderer.SetPosition(2, m);
